...
sys.path.append('/data1/y265607g/dcase_project/m2d')
from examples.portable_m2d import PortableM2D

M2D_CHECKPOINT = '/data1/y265607g/dcase_project/m2d/m2d_clap_vit_base-80x1001p16x16p16kpBpTI-2025/checkpoint-30.pth'
AUDIO_DIR = '/data1/y265607g/dcase_project/wav_data_all'
DATA_DIR = '/data1/y265607g/dcase_project/dcase2026_task6_baseline/data'
AUDIO_FEAT_DIR = '/data1/y265607g/dcase_project/Datascience2026_cgdetr/features_2/castella/m2d_clap'
TEXT_FEAT_DIR = '/data1/y265607g/dcase_project/Datascience2026_cgdetr/features_2/castella/m2d_clap_text'
TARGET_SR = 16000
...
def main(split):
    ...
    for item in tqdm(data):
        qid = item['qid']
        out_path = join(TEXT_FEAT_DIR, f'qid{qid}.npz')   # qid- -> qidに変更
        if exists(out_path):
            continue
